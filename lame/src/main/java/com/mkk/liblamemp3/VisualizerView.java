...
public class VisualizerView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray args = context.obtainStyledAttributes(attrs, com.mkk.liblamemp3.R.styleable.visualizerView);
        mNumColumns = args.getInteger(com.mkk.liblamemp3.R.styleable.visualizerView_numColumns, DEFAULT_NUM_COLUMNS);
        mRenderColor = args.getColor(com.mkk.liblamemp3.R.styleable.visualizerView_renderColor, Color.WHITE);
        mType = args.getInt(com.mkk.liblamemp3.R.styleable.visualizerView_renderType, Type.BAR.getFlag());
        mRenderRange = args.getInteger(com.mkk.liblamemp3.R.styleable.visualizerView_renderRange, RENDAR_RANGE_TOP);
        args.recycle();
    }
    ...
    /**
     * receive volume from {@link com.tyorikan.voicerecordingvisualizer.RecordingSampler}
     *
